...
def test_required_docs_files_exist() -> None:
    """The mirrored Sphinx entrypoints are tracked in the repository."""
    required_paths = [
        REPO_ROOT / "docs" / "index.rst",
        REPO_ROOT / "docs" / "quickstart.rst",
        REPO_ROOT / "docs" / "api.rst",
        REPO_ROOT / "docs" / "reference" / "index.rst",
        REPO_ROOT / "docs" / "reference" / "cli.rst",
        REPO_ROOT / "docs" / "reference" / "session_manager.rst",
        REPO_ROOT / "docs" / "reference" / "tools.rst",
        REPO_ROOT / "docs" / "reference" / "stubs.rst",
