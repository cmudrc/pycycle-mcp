...
def test_project_urls_and_cli_entrypoint_are_declared() -> None:
    ...
    assert project["scripts"]["pycycle-mcp"] == "pycycle_mcp.__main__:main"
...
def test_dev_dependencies_include_docs_and_release_tooling() -> None:
    """The dev extra includes tooling required by the mirrored scaffolding."""
...
def test_makefile_exposes_required_targets() -> None:
    """The Makefile defines the top-level developer workflow targets."""
